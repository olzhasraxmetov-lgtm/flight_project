...
cp .env.example .env
cp .env.test_example - для тестов
Откройте .env и заполните необходимые ключи (DB, Yookassa, SMTP)
...
#  🧪 Тестирование
Проект покрыт интеграционными и unit-тестами. Для запуска тестов используйте:
pytest -v tests/